import SavedInternship, {
  ISavedInternship,
} from '@/models/SavedInternship';
  ...
  async getSavedInternships(
    ...
    const [internships, total] =
      await Promise.all([
        ...
        SavedInternship.countDocuments({
          studentId,
        }),
      ]);
