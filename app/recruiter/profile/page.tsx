...
import { apiFetch, type RecruiterProfileApi } from "@/lib/api";
...
const [companyWebsite, setCompanyWebsite] = useState("");
  ...
  const loadProfile = async () => {
    try {
      const response = await apiFetch<RecruiterProfileApi | null>("/recruiters/profile");
      ...
      const company =
        typeof profile.companyId === "object" && profile.companyId
          ? (profile.companyId as RecruiterCompanyProfile)
          : undefined;
